        ...
        <div className='font-noto'>
            ...
            <div className='text-base my-3'>
              ...
              <div className="flex">
                ...
                <a href='https://drive.google.com/file/d/114lq_Jn8XwmVNOkGIKlpRZWaT-w5dpAe/view?usp=drivesdk' target="_blank" className='inline-flex text-sky-600 my-auto'><img src={cv} className="w-6 h-6 my-auto ml-5 mr-2"/>CV</a>
              </div>
            </div>
            <hr/>
