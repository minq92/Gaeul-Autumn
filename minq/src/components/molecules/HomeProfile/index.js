        ...
        <div className='font-noto'>
            ...
            <div className='text-base my-3'>
              ...
              <div className="flex">
                ...
                <p className='my-1 ml-2'>kimminq(at)kias(dot)re(dot)krddd</p>
                <a href='https://drive.google.com/file/d/1U0D4jGGjvT74_XKh1U9nbq_K98VzyVt_/view?usp=drive_link' target="_blank" className='inline-flex text-sky-600 my-auto'><img src={cv} className="w-6 h-6 my-auto ml-5 mr-2"/>CV</a>
              </div>
            </div>
            <hr/>
